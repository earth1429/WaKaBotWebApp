<template>
    <div class="py-5 bg-black" id="ProductsSection">
        <div class="container pb-5 text-center">
            <h1 class="tz-44px tw-medium tc-white">Product Details</h1>
        ...
        <div class="row text-center tc-white">
            <div class="col-12">
                <div class="row justify-content-center py-3">
                    <div class="col-2 ">
                        <div class="tz-18px">
                            <i class="bi bi-person tz-52px"></i> <br>
                            Reduce Human <br>
                            Resources
                        </div>
                    </div> 
                    <div class="col-2 ">
                        <div class="tz-18px">
                            <i class="bi bi-clock tz-52px"></i> <br>
                            Real-Time <br>
                            Update
                        </div>
                    </div> 
