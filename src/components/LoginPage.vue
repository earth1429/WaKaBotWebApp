                        ...
                        <div class="row">
                            <div class="col-md-7 pe-0">
                                <div class="form-left h-100 py-5 px-5">
                                    <div action="" class="row g-4 tz-22px">
                                        <div class="col-12 tw-medium">
                                        ...
                                        <div class="col-12">
                                            <a @click="passwordReset" href="#" class="float-end text-primary">Forgot
                                                Password?</a>
                                        </div>

                                        <div class="col-12">
                                            <button @click="login" type="submit"
                                                class="btn bg-black tc-white px-4 float-end mt-4">login</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
